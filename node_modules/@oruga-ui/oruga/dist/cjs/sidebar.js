...
var script = {
  ...
  props: {
    ...
    */
    ...
    position: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'sidebar.position', 'fixed');
      },
      validator: value => {
    ...
    canCancel: {
      type: [Array, Boolean],
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'sidebar.canCancel', ['escape', 'outside']);
      }
    },
  ...
  computed: {
    ...
    cancelOptions() {
      return typeof this.canCancel === 'boolean' ? this.canCancel ? helpers.getValueByPath(config.getOptions(), 'sidebar.canCancel', ['escape', 'outside']) : [] : this.canCancel;
    },
