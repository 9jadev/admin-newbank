...
require('./FormElementMixin-bc2b3815.js');
var Input = require('./Input-e2704d9c.js');
var Button = require('./Button-de8d0fc6.js');
require('./CheckRadioMixin-df88dd8e.js');
var Checkbox = require('./Checkbox-919a3162.js');
var MatchMediaMixin = require('./MatchMediaMixin-41fa9bbb.js');
var Select = require('./Select-47d48a49.js');
var Field = require('./Field-0406d28d.js');
require('./ssr-39c7e185.js');
var Loading = require('./Loading-36b28296.js');
var Pagination = require('./Pagination-da0e69e5.js');
...
var __vue_staticRenderFns__$1 = [];
  ...
  const __vue_component__$2 = /*#__PURE__*/plugins$1.normalizeComponent(
...
var script$3 = {
  ...
  mixins: [plugins$1.BaseComponentMixin, MatchMediaMixin.MatchMediaMixin],
  configField: 'table',
  inheritAttrs: false,
  ...
  props: {
    ...
    sortIcon: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'table.sortIcon', 'arrow-up');
      }
    },
    ...
    sortIconSize: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'table.sortIconSize', 'small');
      }
    },
    ...
    perPage: {
      type: [Number, String],
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'table.perPage', 20);
      }
    },
    ...
    paginationPosition: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'table.paginationPosition', 'bottom');
      },
      validator: value => {
    ...
    showHeader: {
      type: Boolean,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'table.showHeader', true);
      }
    },
    ...
    newColumns() {
      if (this.columns && this.columns.length) {
        return this.columns.map(column => {
          const TableColumnComponent = config.VueInstance.extend(__vue_component__$1);
...
var __vue_staticRenderFns__$2 = [];
  ...
  const __vue_component__$3 = /*#__PURE__*/plugins$1.normalizeComponent(
...
const Plugin = {
  install(Vue) {
    ...
    plugins$1.registerComponent(Vue, __vue_component__$3);
