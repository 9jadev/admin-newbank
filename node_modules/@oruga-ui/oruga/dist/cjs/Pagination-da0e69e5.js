...
var script$1 = {
  ...
  props: {
    ...
    perPage: {
      type: [Number, String],
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'pagination.perPage', 20);
      }
    },
    ...
    order: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'pagination.order', 'right');
      }
    },
    ...
    iconPrev: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'pagination.iconPrev', 'chevron-left');
      }
    },
    ...
    iconNext: {
      type: String,
      default: () => {
        return helpers.getValueByPath(config.getOptions(), 'pagination.iconNext', 'chevron-right');
      }
    },
