...
var script = {
  ...
  computed: {
    ...
    cancelOptions() {
      return typeof this.canCancel === 'boolean' ? this.canCancel ? helpers.getValueByPath(config.getOptions(), 'modal.canCancel', ['escape', 'x', 'outside', 'button']) : [] : this.canCancel;
    },
...
const Plugin = {
  install(Vue) {
    ...
    plugins$1.registerComponentProgrammatic(Vue, 'modal', ModalProgrammatic);
  }
