...
var TabbedChildMixin = require('./TabbedChildMixin-08144384.js');
...
var script = {
  ...
  configField: 'steps',
  mixins: [plugins$1.BaseComponentMixin, MatchMediaMixin.MatchMediaMixin, TabbedChildMixin.TabbedMixin('step')],
  props: {
    /**
...
var script$1 = {
  name: 'OStepItem',
  mixins: [plugins$1.BaseComponentMixin, TabbedChildMixin.TabbedChildMixin('step')],
  configField: 'steps',
  props: {
