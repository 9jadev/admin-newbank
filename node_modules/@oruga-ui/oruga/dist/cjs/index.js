...
require('./InstanceRegistry-70c57269.js');
...
var Tooltip = require('./Tooltip-2592db38.js');
var slider = require('./slider.js');
require('./SlotComponent-0a757062.js');
require('./TabbedChildMixin-08144384.js');
...
const Oruga = {
  install(Vue, options = {}) {
    ...
    for (const componentKey in plugins) {
      plugins$1.registerPlugin(Vue, plugins[componentKey]);
    } // Config component


    plugins$1.registerComponentProgrammatic(Vue, 'config', config.Programmatic);
  }
...
exports.OInputitems = inputitems.OInputitems;
...
exports.OMenuList = menu.OMenuList;
